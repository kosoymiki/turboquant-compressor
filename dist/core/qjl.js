 ...
 */
export function optimalQJLDimensions(nPoints, distortion = 0.1, delta = 0.1) {
 ...
 */
export function estimateQJLCompressionRatio(originalDimensions, targetDimensions, bitsPerValue) {
