...
export class RotationEngine {
    ...
    signFlipPattern;
    mode;
    constructor(dimensions, seed = 0, mode = FWHT_SIGN) {
        if (mode === DENSE_QR_DEBUG) {
            throw new Error('DENSE_QR_DEBUG is not implemented in v3.2.0; use FWHT_SIGN or NONE');
        }
