...
export function estimateCompressionMemory(dimensions, vectorCount, bitsPerValue) {
...
export function validateCompressionParams(dimensions, vectorCount, bitsPerValue) {
...
export function validateSearchParams(dimensions, k, maxVectors) {
    if (k < 1 || k > maxVectors) {
