...
import { getCliProfile } from './tools/cli_profile.js';
...
const server = new McpServer({ name: 'turboquant-compressor', version: '3.3.0' }, { capabilities: {} });
...
server.registerTool('turboquant_compress', {
...
server.registerTool('turboquant_vector_search', {
...
server.registerTool('turboquant_cost_analyze', {
...
server.registerTool('turboquant_cache_plan', {
...
server.registerTool('turboquant_prompt_cache_lint', {
...
server.registerTool('turboquant_context_pack_build', {
...
server.registerTool('turboquant_context_pack_search', {
...
server.registerTool('turboquant_cli_mcp_profile', {
...
server.registerTool('turboquant_quantize', {
    ...
    const result = turboquantQuantize(args);
    return { content: [{ type: 'text', text: JSON.stringify(result) }] };
});
server.registerTool('turboquant_kv_analyze', {
    ...
    const result = turboquantKvAnalyze(args);
    return { content: [{ type: 'text', text: JSON.stringify(result) }] };
});
server.registerTool('turboquant_backend_probe', {
    ...
    const result = turboquantBackendProbe(args);
    return { content: [{ type: 'text', text: JSON.stringify(result) }] };
});
server.registerTool('turboquant_opencl_probe', {
    ...
    const result = turboquantOpenclProbe(args);
    return { content: [{ type: 'text', text: JSON.stringify(result) }] };
});
server.registerTool('turboquant_adreno_loader_probe', {
    ...
    const result = turboquantAdrenoLoaderProbe(args);
    return { content: [{ type: 'text', text: JSON.stringify(result) }] };
});
