...
export function probeOpenCl(options = {}) {
    ...
    const loaderState = clInfoWorked ? 'READY'
        : blocked ? 'BLOCKED_BY_ANDROID_LINKER_NAMESPACE'
            : 'LOADABLE_NO_PLATFORMS';
    return {
