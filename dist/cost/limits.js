...
export function validateContextFiles(files) {
...
export function validateCostSnapshots(snapshots) {
...
export function validateCacheBlocks(blocks) {
...
export function validateInlineChunkBytes(bytes) {
    if (bytes < 0) {
