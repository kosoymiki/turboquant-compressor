export type CacheTier = 'static_1h_candidate' | 'session_5m_candidate' | 'dynamic_uncached' | 'context_pack_candidate';
export type CostLayer = 'claude_code_prompt_cache' | 'local_mcp_vector_compression' | 'self_hosted_kv_cache';
export type WasteSignalType = 'write_heavy' | 'low_cache_reuse' | 'context_bloat' | 'output_heavy';
...
export interface CacheEfficiencyMetrics {
    ...
    estimatedWasteClass: 'unknown' | 'healthy_cache_reuse' | 'write_heavy' | 'context_bloat' | 'output_heavy';
