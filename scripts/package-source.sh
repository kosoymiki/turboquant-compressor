...
tar \
  ...
  --exclude="${NAME}/native/opencl/cl_kernel_test.c" \
  --exclude="${NAME}/native/opencl/kernels/tq_fused_attention_v2.cl" \
  --exclude="${NAME}/native/opencl/kernels/tq_fused_attention_v3_fp16.cl" \
  --exclude="${NAME}/native/opencl/kernels/tq_fused_attention_v4_fp16.cl" \
  --exclude="${NAME}/native/opencl/kernels/tq_fused_attention_v5_fp16.cl" \
