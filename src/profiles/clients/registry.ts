...
export const genericStdioProfile: ClientProfile = {
  id: 'generic_stdio',
...
export const codexCliProfile: ClientProfile = {
  id: 'codex_cli',
...
export const geminiCliProfile: ClientProfile = {
  id: 'gemini_cli',
  name: 'Gemini CLI',
  transport: 'stdio',
  configSnippet: `{
...
export const opencodeProfile: ClientProfile = {
  id: 'opencode',
  name: 'OpenCode',
  transport: 'stdio',
  configSnippet: `{
...
export const crushProfile: ClientProfile = {
  id: 'crush',
  name: 'Crush',
  transport: 'stdio',
