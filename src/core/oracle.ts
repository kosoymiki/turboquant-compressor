 ...
 */
export function analyzeCharacteristics(data: Float32Array): DataCharacteristics {
  let min = Infinity;
  let max = -Infinity;
  let sum = 0;
  let sumSq = 0;
...
export class QuantizationOracle {
  private characteristics: DataCharacteristics | null = null;
   ...
   */
  optimalBits(tolerance: number = 0.01): number {
