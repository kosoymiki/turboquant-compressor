...
export function packValues(values: number[], bitsPerValue: number): Uint8Array {
  const bitsPerByte = 8;
...
export function unpackValues(bytes: Uint8Array, count: number, bitsPerValue: number): Float32Array {
...
export function packVectors(vectors: Uint8Array[], bitsPerValue: number): Uint8Array {
...
export function packedByteLength(vectorCount: number, dimensions: number, bitsPerValue: number): number {
