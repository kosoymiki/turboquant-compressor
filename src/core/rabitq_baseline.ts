 ...
 */
export function rabitqEncode(vector: Float32Array, seed: number = 0): RaBitQEncoded {
 ...
 */
export function rabitqScore(query: Float32Array, encoded: RaBitQEncoded, seed: number = 0): number {
 ...
 */
export function rabitqBatchScore(query: Float32Array, encoded: RaBitQEncoded[], seed: number = 0): number[] {
 ...
 */
export function exactInnerProduct(a: Float32Array, b: Float32Array): number {
  let sum = 0;
